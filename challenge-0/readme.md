...
- **Consumption Readings:** Stores all energy consumption records and meter reading data.
- **Rules / Obligations:** Contains business rules, compliance obligations, and energy regulations that must be followed.
- **Alerts / Scores:** Holds alerts generated by the system and any risk or anomaly scores.
- **Audit Reports:** Keeps audit logs and reports for traceability and compliance.

**AI Search indexes:**
- **Regulations & Policies:** Stores raw, unstructured text of energy regulations and policies, making them searchable for agents.
